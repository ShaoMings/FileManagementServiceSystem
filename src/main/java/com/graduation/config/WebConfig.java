...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(loginInterceptor()).excludePathPatterns("/s/download/**","/peers/doAdd","/s/**","/check/**","/error/**","/callback/**","/install","/login","/doLogin","/doSignUp","/install/**","/static/**")
                .addPathPatterns("/**");
